...
Например: `repeater('STRING', { repeatTimes: 3, separator: '**', addition: 'PLUS', additionRepeatTimes: 3, additionSeparator: '00' })` => `' **STRINGPLUS00PLUS00PLUS**STRINGPLUS00PLUS00PLUS'`
